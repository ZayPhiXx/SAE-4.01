...
\newcommand{\gear}{\scalerel*{\includegraphics[height=1em]{../assets/gear.png}}{\textrm{X}}}
...
Cette option active donc le \textbf{forwarding} (le \textbf{relayage} des paquets) d'une interface à une autre ou plus précisément d'un réseau à un autre. On pourra ensuite reloader notre sysctl :
\\
